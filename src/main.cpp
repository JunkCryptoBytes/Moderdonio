...
uint256 hashGenesisBlock("0x235da8015e40828e467bf20b336a8b546ed29990b19b9e84635bdd30319f1e32");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Moderdonio: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Moderdonio Signed Message:\n";
...
{
    // Moderdonio: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Moderdonio: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Moderdonio: 3.5 days
static const int64 nTargetSpacing = 150; // Moderdonio: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Moderdonio: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Moderdonio: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Moderdonio: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0a475fc8c6f23e2545351b1e8e51f31695ed62c3943976e5f5761220a4da24af");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("8eea305976cb14fc8f97f8103d90ed4243cddbd81e758f8b6b7a7f6c35b88dc267e66d1ff183ecc055c7fe2aae276226e60c549ce71dd64a3983c86453e371dc3f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513634413;
        block.nBits    = 504365644;
        block.nNonce   = 1235949159;

        if (fTestNet)
        {
            block.nTime    = 1513634413;
            block.nNonce   = 3743876204;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc517e9fef65196f61e1c4619347a3467b9cf55de93fa2b9a2bd7c0815cc954e4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Moderdonio: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ModerdonioMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ModerdonioMiner : ProcessBlock, block not accepted");
    }
